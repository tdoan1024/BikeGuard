...
//    sendCommand(message);
  ...
  //SerialUSB.println("[cm]");
    ...
    SerialUSB.println("Spot is occupied by car");
    digitalWrite(WIOLTE_D20, HIGH);
    carCheck = 1;
  }else if(distance > 60 && carCheck == 1) {
     // Send message to server how long car been parked
    SerialUSB.print("Total time parked was: ");
    ...
    carCheck = 0;
    SerialUSB.println("The spot is available ");
